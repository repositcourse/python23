...
answ1 = input("Введите имя устройства: ")
answ2 = input(f'Введите имя параметра ({", ".join(list(london_co[answ1].keys()))}): ')
print(london_co[answ1].get(answ2.lower(), 'Такого параметра нет'))
